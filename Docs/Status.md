...
* **Collections**: A group of classes to contain objects.
    ...
    | `NSSet`               | Mostly Complete | Incomplete    | `NSCoding` with non-keyed-coding archivers,`description(withLocale:)` and `customMirror` remain unimplemented                                                                                                  |
    | `NSMutableSet`        | Complete        | Incomplete    |                                                                                                                                                                     |
    | `NSCountedSet`        | Complete        | Incomplete    |                                                                                                                                                                     |
...
* **String**: A set of classes for scanning, manipulating and storing string values.
    ...
    | `NSTextCheckingResult`      | Mostly Complete | Incomplete    | `NSCopying`, `resultType`, and `range(at:)` remain unimplemented                                                                                     |
    ...
    | `NSCharacterSet`            | Complete        | Incomplete    |                                                                                                                                                                  |
    | `NSMutableCharacterSet`     | Complete        | None          |                                                                                                                                                                  |
