...
const CFIndex _kCFXMLInterfaceRecover = XML_PARSE_RECOVER;
const CFIndex _kCFXMLInterfaceNoEnt = XML_PARSE_NOENT;
const CFIndex _kCFXMLInterfaceDTDLoad = XML_PARSE_DTDLOAD;
const CFIndex _kCFXMLInterfaceDTDAttr = XML_PARSE_DTDATTR;
const CFIndex _kCFXMLInterfaceDTDValid = XML_PARSE_DTDVALID;
const CFIndex _kCFXMLInterfaceNoError = XML_PARSE_NOERROR;
const CFIndex _kCFXMLInterfaceNoWarning = XML_PARSE_NOWARNING;
const CFIndex _kCFXMLInterfacePedantic = XML_PARSE_PEDANTIC;
const CFIndex _kCFXMLInterfaceNoBlanks = XML_PARSE_NOBLANKS;
const CFIndex _kCFXMLInterfaceSAX1 = XML_PARSE_SAX1;
const CFIndex _kCFXMLInterfaceXInclude = XML_PARSE_XINCLUDE;
const CFIndex _kCFXMLInterfaceNoNet = XML_PARSE_NONET;
const CFIndex _kCFXMLInterfaceNoDict = XML_PARSE_NODICT;
const CFIndex _kCFXMLInterfaceNSClean = XML_PARSE_NSCLEAN;
const CFIndex _kCFXMLInterfaceNoCdata = XML_PARSE_NOCDATA;
const CFIndex _kCFXMLInterfaceNoXIncnode = XML_PARSE_NOXINCNODE;
const CFIndex _kCFXMLInterfaceCompact = XML_PARSE_COMPACT;
const CFIndex _kCFXMLInterfaceOld10 = XML_PARSE_OLD10;
const CFIndex _kCFXMLInterfaceNoBasefix = XML_PARSE_NOBASEFIX;
const CFIndex _kCFXMLInterfaceHuge = XML_PARSE_HUGE;
const CFIndex _kCFXMLInterfaceOldsax = XML_PARSE_OLDSAX;
const CFIndex _kCFXMLInterfaceIgnoreEnc = XML_PARSE_IGNORE_ENC;
const CFIndex _kCFXMLInterfaceBigLines = XML_PARSE_BIG_LINES;

const CFIndex _kCFXMLTypeInvalid = 0;
const CFIndex _kCFXMLTypeDocument = XML_DOCUMENT_NODE;
const CFIndex _kCFXMLTypeElement = XML_ELEMENT_NODE;
const CFIndex _kCFXMLTypeAttribute = XML_ATTRIBUTE_NODE;
const CFIndex _kCFXMLTypeProcessingInstruction = XML_PI_NODE;
const CFIndex _kCFXMLTypeComment = XML_COMMENT_NODE;
const CFIndex _kCFXMLTypeText = XML_TEXT_NODE;
const CFIndex _kCFXMLTypeCDataSection = XML_CDATA_SECTION_NODE;
const CFIndex _kCFXMLTypeDTD = XML_DTD_NODE;
const CFIndex _kCFXMLDocTypeHTML = XML_DOC_HTML;
const CFIndex _kCFXMLTypeNamespace = 22; // libxml2 does not define namespaces as nodes, so we have to fake it

const CFIndex _kCFXMLDTDNodeTypeEntity = XML_ENTITY_DECL;
const CFIndex _kCFXMLDTDNodeTypeAttribute = XML_ATTRIBUTE_DECL;
const CFIndex _kCFXMLDTDNodeTypeElement = XML_ELEMENT_DECL;
const CFIndex _kCFXMLDTDNodeTypeNotation = XML_NOTATION_NODE;

const CFIndex _kCFXMLDTDNodeElementTypeUndefined = XML_ELEMENT_TYPE_UNDEFINED;
const CFIndex _kCFXMLDTDNodeElementTypeEmpty = XML_ELEMENT_TYPE_EMPTY;
const CFIndex _kCFXMLDTDNodeElementTypeAny = XML_ELEMENT_TYPE_ANY;
const CFIndex _kCFXMLDTDNodeElementTypeMixed = XML_ELEMENT_TYPE_MIXED;
const CFIndex _kCFXMLDTDNodeElementTypeElement = XML_ELEMENT_TYPE_ELEMENT;

const CFIndex _kCFXMLDTDNodeEntityTypeInternalGeneral = XML_INTERNAL_GENERAL_ENTITY;
const CFIndex _kCFXMLDTDNodeEntityTypeExternalGeneralParsed = XML_EXTERNAL_GENERAL_PARSED_ENTITY;
const CFIndex _kCFXMLDTDNodeEntityTypeExternalGeneralUnparsed = XML_EXTERNAL_GENERAL_UNPARSED_ENTITY;
const CFIndex _kCFXMLDTDNodeEntityTypeInternalParameter = XML_INTERNAL_PARAMETER_ENTITY;
const CFIndex _kCFXMLDTDNodeEntityTypeExternalParameter = XML_EXTERNAL_PARAMETER_ENTITY;
const CFIndex _kCFXMLDTDNodeEntityTypeInternalPredefined = XML_INTERNAL_PREDEFINED_ENTITY;

const CFIndex _kCFXMLDTDNodeAttributeTypeCData = XML_ATTRIBUTE_CDATA;
const CFIndex _kCFXMLDTDNodeAttributeTypeID = XML_ATTRIBUTE_ID;
const CFIndex _kCFXMLDTDNodeAttributeTypeIDRef = XML_ATTRIBUTE_IDREF;
const CFIndex _kCFXMLDTDNodeAttributeTypeIDRefs = XML_ATTRIBUTE_IDREFS;
const CFIndex _kCFXMLDTDNodeAttributeTypeEntity = XML_ATTRIBUTE_ENTITY;
const CFIndex _kCFXMLDTDNodeAttributeTypeEntities = XML_ATTRIBUTE_ENTITIES;
const CFIndex _kCFXMLDTDNodeAttributeTypeNMToken = XML_ATTRIBUTE_NMTOKEN;
const CFIndex _kCFXMLDTDNodeAttributeTypeNMTokens = XML_ATTRIBUTE_NMTOKENS;
const CFIndex _kCFXMLDTDNodeAttributeTypeEnumeration = XML_ATTRIBUTE_ENUMERATION;
const CFIndex _kCFXMLDTDNodeAttributeTypeNotation = XML_ATTRIBUTE_NOTATION;

const CFIndex _kCFXMLNodePreserveWhitespace = 1 << 25;
const CFIndex _kCFXMLNodeCompactEmptyElement = 1 << 2;
const CFIndex _kCFXMLNodePrettyPrint = 1 << 17;
const CFIndex _kCFXMLNodeLoadExternalEntitiesNever = 1 << 19;
const CFIndex _kCFXMLNodeLoadExternalEntitiesAlways = 1 << 14;
