...
internal typealias NumberBridgeType = _ObjectTypeBridgeable
...
internal typealias NumberBridgeType = _ObjectiveCBridgeable

#endif

extension Int8 : NumberBridgeType {
    ...
    public static func _forceBridgeFromObjectiveC(_ x: NSNumber, result: inout Int8?) {
        if !_conditionallyBridgeFromObjectiveC(x, result: &result) {
            fatalError("Unable to bridge NSNumber to \(self)")
        }
    }
...
extension UInt8 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Int16 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension UInt16 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Int32 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension UInt32 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Int64 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension UInt64 : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Int : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension UInt : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Float : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Double : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
extension Bool : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
    ...
    public init?(exactly number: NSNumber) {
        ...
        if number === unsafeBitCast(kCFBooleanTrue, to: NSNumber.self) || NSNumber(value: 1) == number {
            self = true
        } else if number === unsafeBitCast(kCFBooleanFalse, to: NSNumber.self) || NSNumber(value: 0) == number {
            self = false
        } else {
            return nil
        }
    ...
    public static func _conditionallyBridgeFromObjectiveC(_ x: NSNumber, result: inout Bool?) -> Bool {
        if x === unsafeBitCast(kCFBooleanTrue, to: NSNumber.self) || NSNumber(value: 1) == x {
            result = true
            return true
        } else if x === unsafeBitCast(kCFBooleanFalse, to: NSNumber.self) || NSNumber(value: 0) == x {
            result = false
            return true
        }
...
extension CGFloat : NumberBridgeType {
    @available(swift, deprecated: 4, renamed: "init(truncating:)")
    public init(_ number: NSNumber) {
...
#if DEPLOYMENT_RUNTIME_SWIFT
    // these cannot be extensions in swift-corelibs-foundation, they must live on NSNumber itself
#else
    @nonobjc
...
extension NSNumber : _HasCustomAnyHashableRepresentation {
    ...
    public func _toCustomAnyHashable() -> AnyHashable? {
        ...
        } else if self === unsafeBitCast(kCFBooleanTrue, to: NSNumber.self) {
            return AnyHashable(true)
        } else if self === unsafeBitCast(kCFBooleanFalse, to: NSNumber.self) {
