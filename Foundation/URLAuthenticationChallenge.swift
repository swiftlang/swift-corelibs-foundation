...
open class URLAuthenticationChallenge : NSObject, NSSecureCoding {
    ...
    private var _protectionSpace: URLProtectionSpace
    private var _proposedCredential: URLCredential?
    private var _previousFailureCount: Int
    private var _failureResponse: URLResponse?
    private var _error: Error?
    private var _sender: URLAuthenticationChallengeSender
...
extension HTTPURLProtocol : URLAuthenticationChallengeSender {
