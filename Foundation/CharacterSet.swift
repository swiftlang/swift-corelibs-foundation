...
fileprivate final class _CharacterSetStorage : Hashable {
    ...
    fileprivate func insert(charactersIn string: String) {
        ...
        case .immutable(let cs):
            let r = CFCharacterSetCreateMutableCopy(nil, cs)!
            CFCharacterSetAddCharactersInString(r, cf)
            _backing = .mutable(r)
        case .mutable(let cs):
            
            CFCharacterSetAddCharactersInString(cs, cf)
        }
    }
    ...
    fileprivate func remove(charactersIn string: String) {
        ...
        case .immutable(let cs):
            let r = CFCharacterSetCreateMutableCopy(nil, cs)!
            CFCharacterSetRemoveCharactersInString(r, cf)
            _backing = .mutable(r)
        case .mutable(let cs):
            CFCharacterSetRemoveCharactersInString(cs, cf)
        }
    }
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLUserAllowedCharacterSet())
#else
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLPasswordAllowedCharacterSet())
#else
        if #available(OSX 10.12, iOS 10.0, watchOS 3.0, tvOS 10.0, *) {
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLHostAllowedCharacterSet())
#else
        if #available(OSX 10.12, iOS 10.0, watchOS 3.0, tvOS 10.0, *) {
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLPathAllowedCharacterSet())
#else
        if #available(OSX 10.12, iOS 10.0, watchOS 3.0, tvOS 10.0, *) {
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLQueryAllowedCharacterSet())
#else
        if #available(OSX 10.12, iOS 10.0, watchOS 3.0, tvOS 10.0, *) {
...
#if DEPLOYMENT_RUNTIME_SWIFT
        return CharacterSet(_uncopiedImmutableReference: _CFURLComponentsGetURLFragmentAllowedCharacterSet())
#else
        if #available(OSX 10.12, iOS 10.0, watchOS 3.0, tvOS 10.0, *) {
...
extension NSCharacterSet : _HasCustomAnyHashableRepresentation {
    ...
    public func _toCustomAnyHashable() -> AnyHashable? {
        return AnyHashable(CharacterSet(_bridged: self))
    }
}
