...
/*!
    ...
    @discussion URLCredentialStorage implements a singleton object (shared instance) which manages the shared credentials cache. Note: Whereas in Mac OS X any application can access any credential with a persistence of URLCredentialPersistencePermanent provided the user gives permission, in iPhone OS an application can access only its own credentials.
*/
open class URLCredentialStorage: NSObject {
    ...
    */
    ...
    /*!
        ...
        has a persistence policy of URLCredentialPersistenceSynchronizable will fail.  
    ...
    */
    ...
    /*!
     ...
     be used when trying to delete a credential that has the URLCredentialPersistenceSynchronizable policy.
     Please note that when URLCredential objects that have a URLCredentialPersistenceSynchronizable policy
...
/*!
    @const URLCredentialStorageChangedNotification
    @abstract This notification is sent on the main thread whenever
    the set of stored credentials changes.
*/
public let URLCredentialStorageChangedNotification: String = "" // NSUnimplemented

/*
 *  URLCredentialStorageRemoveSynchronizableCredentials - (NSNumber value)
 *		A key that indicates either @YES or @NO that credentials which contain the URLCredentialPersistenceSynchronizable
 ...
 */
public let URLCredentialStorageRemoveSynchronizableCredentials: String = "" // NSUnimplemented
