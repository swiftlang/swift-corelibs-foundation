...
public class NSCalendar: NSObject, NSCopying, NSSecureCoding {
    ...
    public var calendarIdentifier: Identifier  {
        get {
    ...
    */
    public func isDate(_ date1: Date, equalTo date2: Date, toUnitGranularity unit: Unit) -> Bool {
    ...
    */
    ...
    /// - Experiment: This is a draft API currently under consideration for official import into Foundation as a suitable alternative
    /// - Note: Since this API is under consideration it may be either removed or revised in the near future
    public func range(ofWeekendContaining date: Date) -> DateInterval? {
    ...
    */
    public func nextDate(after date: Date, matching comps: DateComponents, options: Options = []) -> Date? {
        var result: Date?
    ...
    */
    public func date(bySettingUnit unit: Unit, value v: Int, of date: Date, options opts: Options = []) -> Date? {
    ...
    */
    public func date(bySettingHour h: Int, minute m: Int, second s: Int, of date: Date, options opts: Options = []) -> Date? {
...
public class NSDateComponents : NSObject, NSCopying, NSSecureCoding {
    ...
    */
    public func setValue(_ value: Int, forComponent unit: NSCalendar.Unit) {
        switch unit {
    ...
    */
    public func value(forComponent unit: NSCalendar.Unit) -> Int {
        switch unit {
            case NSCalendar.Unit.era:
                return era
            case NSCalendar.Unit.year:
