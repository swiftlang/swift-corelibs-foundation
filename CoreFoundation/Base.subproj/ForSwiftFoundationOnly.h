...
struct _NSXMLParserBridge {
    ...
    _CFXMLInterfaceParserInput _Nullable (*_Nonnull _xmlExternalEntityWithURL)(_CFXMLInterface _Null_unspecified interface, const char * _Null_unspecified url, const char * _Null_unspecified identifier, _CFXMLInterfaceParserContext context, _CFXMLInterfaceExternalEntityLoader originalLoaderFunction);
