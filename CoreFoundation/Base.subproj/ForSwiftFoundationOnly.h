...
CF_CROSS_PLATFORM_EXPORT __declspec(dllexport) int _CFThreadGetName(char *_Nonnull buf, int length);
...
CF_CROSS_PLATFORM_EXPORT __declspec(dllexport) Boolean _CFBundleSupportsFHSBundles(void);
