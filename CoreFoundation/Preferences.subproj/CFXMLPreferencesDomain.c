...
static CFTypeRef fetchXMLCopyValue(CFTypeRef context, void *xmlDomain, CFStringRef key);
...
const _CFPreferencesDomainCallBacks __kCFXMLPropertyListDomainCallBacks = {createXMLDomain, freeXMLDomain, fetchXMLCopyValue, writeXMLValue, synchronizeXMLDomain, getXMLKeysAndValues, copyXMLDomainDictionary, setXMLDomainIsWorldReadable};
