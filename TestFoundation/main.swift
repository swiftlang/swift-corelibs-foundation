...
XCTMain([
    ...
    testCase(TestNSOrderedSet.allTests),
    testCase(TestNSOperation.allTests),
...
//    testCase(TestNSThread.allTests),
    ...
    testCase(TestNSURLSession.allTests),
    testCase(TestNSURLSessionConfiguration.allTests),
    testCase(TestNSURLSession_Helpers.allTests),
    testCase(TestNSNull.allTests),
